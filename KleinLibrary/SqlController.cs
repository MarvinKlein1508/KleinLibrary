...
using KleinLibrary.TypeHandler;
...
namespace KleinLibrary
{
    ...
    {
        /// <summary>
        /// Ruft den Wert für den Timeout in Sekunden eines SQL-Befehls ab, oder legt diesen fest.
        /// <para>
        /// Dieser Wert gilt nur für die Erstellung eines neuen SQL-Controllers.
        /// </para>
        /// </summary>
        ...
        static SqlController()
        {
            ...
            foreach (Type type in SingletonTypeAttributeCache.CacheAll<CompareFieldAttribute>((att) => att.DatenbankFeld))
            {
